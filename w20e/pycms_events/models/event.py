...
from w20e.forms.rendering.control import Input, DateTime
...
class Event(object):
    ...
    def modify(self, form):
        ...
        grp.addRenderable(DateTime("start", "Start of event", bind="start"))
        grp.addRenderable(DateTime("end", "End of event", bind="end"))
